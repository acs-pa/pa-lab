...
class Task:
    def __init__(self):
        ...
        self.v: list[int] = []     # vectorul de elemente pe care se aplică SCMAX (index 0 nefolosit)
    ...
    def scmax(self) -> SCMAXResult:
        ...
        dp: list[int] = [0] * (self.n + 1)  # Preferăm indexarea de la 1 pentru a fi mai ușor de implementat.
        # prev[i] = poziția elementului precedent din SCMAX care se termină pe poziția i
        prev: list[int] = [0] * (self.n + 1)
